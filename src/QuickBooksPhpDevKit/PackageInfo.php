...
class PackageInfo {
	...
	public const Actions = [
		...
		'DERIVE_INVENTORYITEM' => 'ItemInventoryDerive',
			'OBJECT_ITEMINVENTORY' => 'ItemInventory',
			'ADD_ITEMINVENTORY' => 'ItemInventoryAdd',
			'MOD_ITEMINVENTORY' => 'ItemInventoryMod',
			'QUERY_ITEMINVENTORY' => 'ItemInventoryQuery',
			'IMPORT_ITEMINVENTORY' => 'ItemInventoryImport',
			'DERIVE_ITEMINVENTORY' => 'ItemInventoryDerive',
		...
		'IMPORT_INVENTORYASSEMBLYITEM' => 'ItemInventoryAssemblyImport',
			'OBJECT_ITEMINVENTORYASSEMBLY' => 'ItemInventoryAssembly',
			'ADD_ITEMINVENTORYASSEMBLY' => 'ItemInventoryAssemblyAdd',
			'MOD_ITEMINVENTORYASSEMBLY' => 'ItemInventoryAssemblyMod',
			'QUERY_ITEMINVENTORYASSEMBLY' => 'ItemInventoryAssemblyQuery',
			'IMPORT_ITEMINVENTORYASSEMBLY' => 'ItemInventoryAssemblyImport',
		...
		'IMPORT_GROUPITEM' => 'ItemGroupImport',
			'OBJECT_ITEMGROUP' => 'ItemGroup',
			'ADD_ITEMGROUP' => 'ItemGroupAdd',
			'MOD_ITEMGROUP' => 'ItemGroupMod',
			'QUERY_ITEMGROUP' => 'ItemGroupQuery',
			'IMPORT_ITEMGROUP' => 'ItemGroupImport',
		...
		'IMPORT_NONINVENTORYITEM' => 'ItemNonInventoryImport',
			'OBJECT_ITEMNONINVENTORY' => 'ItemNonInventory',
			'ADD_ITEMNONINVENTORY' => 'ItemNonInventoryAdd',
			'MOD_ITEMNONINVENTORY' => 'ItemNonInventoryMod',
			'QUERY_ITEMNONINVENTORY' => 'ItemNonInventoryQuery',
			'IMPORT_ITEMNONINVENTORY' => 'ItemNonInventoryImport',
		...
		'IMPORT_DISCOUNTITEM' => 'ItemDiscountImport',
			'OBJECT_ITEMDISCOUNT' => 'ItemDiscount',
			'ADD_ITEMDISCOUNT' => 'ItemDiscountAdd',
			'MOD_ITEMDISCOUNT' => 'ItemDiscountMod',
			'QUERY_ITEMDISCOUNT' => 'ItemDiscountQuery',
			'IMPORT_ITEMDISCOUNT' => 'ItemDiscountImport',
		...
		'IMPORT_FIXEDASSETITEM' => 'ItemFixedAssetImport',
			'OBJECT_ITEMFIXEDASSET' => 'ItemFixedAsset',
			'ADD_ITEMFIXEDASSET' => 'ItemFixedAssetAdd',
			'MOD_ITEMFIXEDASSET' => 'ItemFixedAssetMod',
			'QUERY_ITEMFIXEDASSET' => 'ItemFixedAssetQuery',
			'IMPORT_ITEMFIXEDASSET' => 'ItemFixedAssetImport',
		...
		'IMPORT_PAYMENTITEM' => 'ItemPaymentImport',
			'OBJECT_ITEMPAYMENT' => 'ItemPayment',
			'ADD_ITEMPAYMENT' => 'ItemPaymentAdd',
			'MOD_ITEMPAYMENT' => 'ItemPaymentMod',
			'QUERY_ITEMPAYMENT' => 'ItemPaymentQuery',
			'IMPORT_ITEMPAYMENT' => 'ItemPaymentImport',

		'OBJECT_SERVICEITEM' => 'ItemService',
		...
		'IMPORT_SERVICEITEM' => 'ItemServiceImport',
			'OBJECT_ITEMSERVICE' => 'ItemService',
			'ADD_ITEMSERVICE' => 'ItemServiceAdd',
			'MOD_ITEMSERVICE' => 'ItemServiceMod',
			'QUERY_ITEMSERVICE' => 'ItemServiceQuery',
			'IMPORT_ITEMSERVICE' => 'ItemServiceImport',
		...
		'IMPORT_SALESTAXITEM' => 'ItemSalesTaxImport',
			'OBJECT_ITEMSALESTAX' => 'ItemSalesTax',
			'ADD_ITEMSALESTAX' => 'ItemSalesTaxAdd',
			'MOD_ITEMSALESTAX' => 'ItemSalesTaxMod',
			'QUERY_ITEMSALESTAX' => 'ItemSalesTaxQuery',
			'IMPORT_ITEMSALESTAX' => 'ItemSalesTaxImport',
		...
		'IMPORT_SALESTAXGROUPITEM' => 'ItemSalesTaxGroupImport',
			'OBJECT_ITEMSALESTAXGROUP' => 'ItemSalesTaxGroup',
			'ADD_ITEMSALESTAXGROUP' => 'ItemSalesTaxGroupAdd',
			'MOD_ITEMSALESTAXGROUP' => 'ItemSalesTaxGroupMod',
			'QUERY_ITEMSALESTAXGROUP' => 'ItemSalesTaxGroupQuery',
			'IMPORT_ITEMSALESTAXGROUP' => 'ItemSalesTaxGroupImport',
		...
		'IMPORT_OTHERCHARGEITEM' => 'ItemOtherChargeImport',
			'OBJECT_ITEMOTHERCHARGE' => 'ItemOtherCharge',
			'ADD_ITEMOTHERCHARGE' => 'ItemOtherChargeAdd',
			'MOD_ITEMOTHERCHARGE' => 'ItemOtherChargeMod',
			'QUERY_ITEMOTHERCHARGE' => 'ItemOtherChargeQuery',
			'IMPORT_ITEMOTHERCHARGE' => 'ItemOtherChargeImport',
		...
		'IMPORT_SUBTOTALITEM' => 'ItemSubtotalImport',
			'OBJECT_ITEMSUBTOTAL' => 'ItemSubtotal',
			'ADD_ITEMSUBTOTAL' => 'ItemSubtotalAdd',
			'MOD_ITEMSUBTOTAL' => 'ItemSubtotalMod',
			'QUERY_ITEMSUBTOTAL' => 'ItemSubtotalQuery',
			'IMPORT_ITEMSUBTOTAL' => 'ItemSubtotalImport',
