 ...
 */
class AccountTaxLineInfoQueryRq extends AbstractSchemaObject
{
	...
	{
		static $paths = [
			'AccountTaxLineInfoQueryRq' => 'string',
		];
	...
	{
		static $paths = [
			'AccountTaxLineInfoQueryRq' => false,
		];
