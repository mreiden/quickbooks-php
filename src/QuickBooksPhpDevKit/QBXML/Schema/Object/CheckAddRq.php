 ...
 */
final class CheckAddRq extends AbstractSchemaObject
{
	/**
	 * Object's QBXML wrapping tag type
	 * @var string
	 */
	protected $_qbxmlWrapper = 'CheckAdd';
	...
	protected $_sinceVersionPaths = [
		...
		'ExchangeRate' => 8.0,
		'ExternalGUID' => 9.0,
		'ApplyCheckToTxnAdd TxnID' => 7.0,
		'ApplyCheckToTxnAdd Amount' => 7.0,
	...
	protected $_localeExcludedPaths = [
		...
		'ExchangeRate' => ['OE'],
		'ExternalGUID' => ['OE'],
		'ApplyCheckToTxnAdd TxnID' => ['OE'],
		'ApplyCheckToTxnAdd Amount' => ['OE'],
