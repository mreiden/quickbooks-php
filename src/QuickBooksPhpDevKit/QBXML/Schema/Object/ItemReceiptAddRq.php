 ...
 */
final class ItemReceiptAddRq extends AbstractSchemaObject
{
	/**
	 * Object's QBXML wrapping tag type
	 * @var string
	 */
	protected $_qbxmlWrapper = 'ItemReceiptAdd';
	...
	protected $_localeExcludedPaths = [
		...
		'ExpenseLineAdd TaxAmount' => ['US','CA','UK'],
		'ExpenseLineAdd SalesTaxCodeRef ListID' => ['US'],
		'ExpenseLineAdd SalesTaxCodeRef FullName' => ['US'],
		'ItemLineAdd InventorySiteRef ListID' => ['AU'],
		'ItemLineAdd InventorySiteRef FullName' => ['AU'],
		'ItemLineAdd InventorySiteLocationRef ListID' => ['AU'],
		'ItemLineAdd InventorySiteLocationRef FullName' => ['AU'],
		'ItemLineAdd SerialNumber' => ['AU'],
		'ItemLineAdd LotNumber' => ['AU'],
		'ItemLineAdd TaxAmount' => ['US','CA','UK'],
		'ItemLineAdd SalesTaxCodeRef ListID' => ['US'],
		'ItemLineAdd SalesTaxCodeRef FullName' => ['US'],
		'ItemGroupLineAdd Desc' => ['US','CA','UK','AU'],
		'ItemGroupLineAdd InventorySiteRef ListID' => ['AU'],
		'ItemGroupLineAdd InventorySiteRef FullName' => ['AU'],
		'ItemGroupLineAdd InventorySiteLocationRef ListID' => ['AU'],
		'ItemGroupLineAdd InventorySiteLocationRef FullName' => ['AU'],
	];
