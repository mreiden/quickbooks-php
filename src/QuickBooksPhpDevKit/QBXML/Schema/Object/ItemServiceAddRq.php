 ...
 */
final class ItemServiceAddRq extends AbstractSchemaObject
{
	/**
	 * Object's QBXML wrapping tag type
	 * @var string
	 */
	protected $_qbxmlWrapper = 'ItemServiceAdd';
	...
	protected $_localeExcludedPaths = [
		...
		'SalesAndPurchase SalesDesc' => ['OE'],
		'SalesAndPurchase SalesPrice' => ['OE'],
		'SalesAndPurchase IncomeAccountRef ListID' => ['OE'],
		'SalesAndPurchase IncomeAccountRef FullName' => ['OE'],
		'SalesAndPurchase PurchaseDesc' => ['OE'],
		'SalesAndPurchase PurchaseCost' => ['OE'],
		'SalesAndPurchase PurchaseTaxCodeRef ListID' => ['US','OE'],
		'SalesAndPurchase PurchaseTaxCodeRef FullName' => ['US','OE'],
		'SalesAndPurchase ExpenseAccountRef ListID' => ['OE'],
		'SalesAndPurchase ExpenseAccountRef FullName' => ['OE'],
		'SalesAndPurchase PrefVendorRef ListID' => ['OE'],
		'SalesAndPurchase PrefVendorRef FullName' => ['OE'],
		'ExternalGUID' => ['OE'],
