...
/**
 * Schema object for: TaxCategoryModRq
 *
 ...
 */
final class TaxCategoryModRq extends AbstractSchemaObject
{
	/**
	...
	protected $_dataTypePaths = [
		'TaxCategoryMod TaxCategoryListID' => 'IDTYPE',
		'TaxCategoryMod TaxCategory' => 'STRTYPE',
		'TaxCategoryMod ShippingTaxCode' => 'STRTYPE',
	];
	...
	protected $_maxLengthPaths = [
		'TaxCategoryMod TaxCategory' => 20,
		'TaxCategoryMod ShippingTaxCode' => 3,
	];
	...
	protected $_reorderPathsPaths = [
		'TaxCategoryMod',
		'TaxCategoryMod TaxCategoryListID',
		'TaxCategoryMod TaxCategory',
		'TaxCategoryMod ShippingTaxCode',
	];
}
