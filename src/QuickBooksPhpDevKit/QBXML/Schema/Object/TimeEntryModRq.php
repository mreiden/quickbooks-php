...
/**
 * Schema object for: TimeEntryModRq
 *
 ...
 */
final class TimeEntryModRq extends AbstractSchemaObject
{
	/**
	...
	protected $_dataTypePaths = [
		'TimeEntryMod ListID' => 'IDTYPE',
		'TimeEntryMod ClockInTime' => 'DATETIMETYPE',
		'TimeEntryMod ClockOutTime' => 'DATETIMETYPE',
		'TimeEntryMod CreatedBy' => 'STRTYPE',
		'TimeEntryMod EmployeeListID' => 'IDTYPE',
		'TimeEntryMod StoreNumber' => 'INTTYPE',
	...
	protected $_reorderPathsPaths = [
		'TimeEntryMod',
		'TimeEntryMod ListID',
		'TimeEntryMod ClockInTime',
		'TimeEntryMod ClockOutTime',
		'TimeEntryMod CreatedBy',
		'TimeEntryMod EmployeeListID',
		'TimeEntryMod StoreNumber',
		'IncludeRetElement',
	];
}
