...
/**
 * Schema object for: InventoryCostAdjustmentQueryRq
 *
 ...
 */
final class InventoryCostAdjustmentQueryRq extends AbstractSchemaObject
{
	/**
	...
	protected $_dataTypePaths = [
		...
		'NewCostFilter MatchNumericCriterion' => 'ENUMTYPE',
		'NewCostFilter NewCost' => 'AMTTYPE',
		'NewCostRangeFilter FromNewCost' => 'AMTTYPE',
		'NewCostRangeFilter ToNewCost' => 'AMTTYPE',
		'OldCostFilter MatchNumericCriterion' => 'ENUMTYPE',
		'OldCostFilter OldCost' => 'AMTTYPE',
		'OldCostRangeFilter FromOldCost' => 'AMTTYPE',
		'OldCostRangeFilter ToOldCost' => 'AMTTYPE',
	...
	protected $_reorderPathsPaths = [
		...
		'NewCostFilter',
		'NewCostFilter MatchNumericCriterion',
		'NewCostFilter NewCost',
		'NewCostRangeFilter',
		'NewCostRangeFilter FromNewCost',
		'NewCostRangeFilter ToNewCost',
		'OldCostFilter',
		'OldCostFilter MatchNumericCriterion',
		'OldCostFilter OldCost',
		'OldCostRangeFilter',
		'OldCostRangeFilter FromOldCost',
		'OldCostRangeFilter ToOldCost',
		'QuickBooksFlag',
		'ReasonFilter',
