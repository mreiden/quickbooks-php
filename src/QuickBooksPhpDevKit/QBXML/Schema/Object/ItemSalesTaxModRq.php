 ...
 */
final class ItemSalesTaxModRq extends AbstractSchemaObject
{
	/**
	 * Object's QBXML wrapping tag type
	 * @var string
	 */
	protected $_qbxmlWrapper = 'ItemSalesTaxMod';
	...
	protected $_maxLengthPaths = [
		...
		'SalesTaxReturnLineRef FullName' => 91,
	...
	protected $_sinceVersionPaths = [
		...
		'SalesTaxReturnLineRef ListID' => 8.0,
		'SalesTaxReturnLineRef FullName' => 8.0,
	...
	protected $_localeExcludedPaths = [
		...
		'SalesTaxReturnLineRef ListID' => ['US'],
		'SalesTaxReturnLineRef FullName' => ['US'],
	];
