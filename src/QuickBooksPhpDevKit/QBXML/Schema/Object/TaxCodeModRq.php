...
/**
 * Schema object for: TaxCodeModRq
 *
 ...
 */
final class TaxCodeModRq extends AbstractSchemaObject
{
	/**
	...
	protected $_dataTypePaths = [
		'TaxCodeMod POSTaxCodeListID' => 'IDTYPE',
		'TaxCodeMod POSTaxCode' => 'STRTYPE',
		'TaxCodeMod POSTaxCodeName' => 'STRTYPE',
		'TaxCodeMod POSTaxCodeMark' => 'STRTYPE',
	];
	...
	protected $_maxLengthPaths = [
		'TaxCodeMod POSTaxCode' => 3,
		'TaxCodeMod POSTaxCodeName' => 31,
		'TaxCodeMod POSTaxCodeMark' => 1,
	];
	...
	protected $_reorderPathsPaths = [
		'TaxCodeMod',
		'TaxCodeMod POSTaxCodeListID',
		'TaxCodeMod POSTaxCode',
		'TaxCodeMod POSTaxCodeName',
		'TaxCodeMod POSTaxCodeMark',
	];
}
